# PuniCore (糯芯核心) ~ 开发者小伙伴，欢迎来到糯芯世界！(≧∇≦)ﾉ
...
**PuniCore (糯芯核心)** 专注于用 **Golang** 开发高性能机器人框架，为开发者小伙伴们提供：

- 🚀 **高效稳定的核心引擎** - Golang的高并发性能全力驱动！
- 🧩 **轻松扩展的插件系统** - 像拼接积木一样简单~
...
### 4. 单元测试の铠甲
- 新功能请穿上 **单元测试铠甲**！守护代码的和平就靠你了 (•̀o•́)ง
